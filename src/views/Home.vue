<template>
  <div class="home">
    <v-container>
      ...
      <p>Prior to all that I ran a small one man web development company called <b>Data Driven Design</b> for about 10 years. At DDD I used <b>PHP</b> and <b>MySQL</b> to build web applications. <b>PHP</b> is a good technology for a solo developer as it is a versatile work horse with capabilities in form handling, image manipulation, database queries, and much more. At the time <b>PHP</b> did not have the frameworks that have become popular of late such as <b>Laravel</b>, <b>Code Igniter</b>, and <b>CakePHP</b>.</p>
